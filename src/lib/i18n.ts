...
const dictionary = {
  ...
  dk: {
    siteTagline: "Autoloke – find nemt køretøjer og reservedele tæt på dig",
    login: "Log ind",
    logout: "Log ud",
    ...
    loading: "Indlæser...",
    searchingVehicle: "Søg efter køretøjer",
    searchingParts: "Søg efter reservedele",
    ...
    year: "År",
    titleNoPhoto: "Intet billede",
    firestoreAds: "Annoncer fra Firestore",
    activeSeparate: "vises separat i nærheden",
  },
} as const;
